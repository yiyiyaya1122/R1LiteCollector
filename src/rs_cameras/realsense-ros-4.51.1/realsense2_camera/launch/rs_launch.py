...
configurable_parameters = [{'name': 'camera_name',                  'default': 'camera', 'description': 'camera unique name'},
                            ...
                            # must comment it to enable auto exposure in d405
                            ...
                            # can be deleted
                            {'name': 'depth_module.enable_auto_exposure', 'default': 'true', 'description': 'auto_exposure'},

                            {'name': 'initial_reset', 'default': 'true', 'description': 'initial_reset'},

                            {'name': 'wait_for_device_timeout',      'default': '-1.', 'description': 'Timeout for waiting for device to connect (Seconds)'},
                            {'name': 'reconnect_timeout',            'default': '6.', 'description': 'Timeout(seconds) between consequtive reconnection attempts'},

                            # to fix l515 stamp delay
                            {'name': 'depth_module.global_time_enabled',          'default': 'true', 'description': 'global_time_enabled'},
                            {'name': 'rgb_camera.global_time_enabled',             'default': 'true', 'description': 'global_time_enabled'},

                           {'name': 'rgb_camera.auto_exposure_priority', 'default': 'false', 'description': 'auto_exposure_priority'},
                          ]
    ...
    if (os.getenv('ROS_DISTRO') == "dashing") or (os.getenv('ROS_DISTRO') == "eloquent"):
        return LaunchDescription(declare_configurable_parameters(configurable_parameters) + [
            ...
            launch_ros.actions.Node(
                ...
                respawn=True,                # Auto-respawn on failure
                respawn_delay=5.0,           # Wait 5 seconds before respawn
                output='screen',              # Show logs for debugging
