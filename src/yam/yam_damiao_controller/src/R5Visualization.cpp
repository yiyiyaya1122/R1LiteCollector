#include "yam_damiao_controller/R5Visualization.hpp"
...
namespace yam
{
    R5Visualization::R5Visualization() : Node("r5_visualization_node")
    {
        ...
        joint_state_subscriber_ = this->create_subscription<yam_arm_msg::msg::YamStatus>(
    ...
    void R5Visualization::subArmCallback(const yam_arm_msg::msg::YamStatus::SharedPtr msg)
    {
...
int main(int argc, char *argv[])
{
    ...
    rclcpp::spin(std::make_shared<yam::R5Visualization>());
    rclcpp::shutdown();
    return 0;
}
